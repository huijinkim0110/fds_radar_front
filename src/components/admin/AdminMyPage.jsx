          ...
          <Panel title="처리 현황" sub="내 담당 기준" style={{ height: "100%", display: "flex", flexDirection: "column" }}>
            {dashboard ? (
              <div className="admin-stat" style={{ padding: "8px 0", flex: 1, display: "flex", flexDirection: "column", justifyContent: "space-around" }}>
                ...
                <div className="admin-stat-row"><span>접수</span><b>{dashboard.fraud.receivedCaseCount || 0}건</b></div>
                <div className="admin-stat-row"><span>조사중</span><b style={{ color: "var(--amber)" }}>{dashboard.fraud.investigatingCaseCount || 0}건</b></div>
                <div className="admin-stat-row"><span>종결</span><b style={{ color: "var(--green)" }}>{dashboard.fraud.closedCaseCount || 0}건</b></div>
              </div>
            ) : (
